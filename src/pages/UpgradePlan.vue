    ...
    <div class="container mx-auto p-4">
      ...
      <div class="max-w-7xl mx-auto w-full">
        <div class="flex items-center justify-between my-20">
          <h1 class="text-[20px] lg:block hidden font-extrabold">Upgrade Your plan</h1>
  ...
  export default {
    ...
    methods: { 
      ...
      async submitForm(form) {
        this.loading = true;
        try {
          const response = await axios.put('plan/change',{ plan_id: this.formattedPlanId,token: this.stripe}, new FormData(form));
