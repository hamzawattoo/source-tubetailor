      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header">
            You will be charged {{ formattedPrice }} for
              ...
              <div class="row">
                ...
                <div class="col-xl-12 col-lg-12">
                  ...
                  <button
                    ...
                    id="card-button"
                    :data-secret="formattedPlanClientSecret"
                  >
                    Purchase
                  </button>
                </div>
...
document.addEventListener("DOMContentLoaded", (event) => {
  ...
  const stripe = Stripe(
    "pk_test_51MVEAPLS4zkAfcVbnyeGUWCsshFlKyTybYxuFTVH7XNjh7OXBfAq4KKUb85J6p5T70pTyiztLL2hLUdw3cVvcJJS00pWNxURBD"
  );
