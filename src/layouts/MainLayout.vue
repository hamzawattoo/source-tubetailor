<template>
  <div>
    ...
    >
      <!-- Sidebar component, swap this element with another sidebar if you like -->
      <div
        class="flex flex-col px-6 py-4 pb-4 overflow-y-auto bg-white border-r border-gray-200 example grow gap-y-5"
      >
        <div class="flex items-center h-16 shrink-0">
...
onMounted(() => {
  ...
  } else if (currentRoute0 === "/billing") {
    store.setHeadline("Billing");
  }
...
const navigation = [
  ...
  },
  {
    ...
    href: "/billing",
    icon: CreditCardIcon,
    current: currentRoute.value === "/billing",
  },
];
const teams = [
